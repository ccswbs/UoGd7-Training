...
* [Images](#images)
   ...
   * [Aligning Images](#aligning-images)
	 ...
	 * [Floating Images Left](#floating-images-left)
	 * [Floating Images Right](#floating-images-right)
	 * [Clearing Floating Images](#clearing-floating-images)
   ...
   * [Creating a Responsive Image Grid with Bootstrap](#creating-a-responsive-image-grid-with-bootstrap)
   	 * [2 Column Responsive Image Grid](#2-column-responsive-image-grid)
	 * [3 Column Responsive Image Grid](#3-column-responsive-image-grid)
   * [Image Overlay](#image-overlay)
   	 * [Image Overylay with Single Heading Caption](#image-overlay-with-single-heading-caption)
	 * [Image Overylay with Two Captions](#image-overlay-with-two-captions)
